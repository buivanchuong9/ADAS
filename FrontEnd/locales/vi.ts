export default {
  ...
  nav: {
    ...
    adasMonitorDesc: "Phân tích hành trình",
    driverMonitorDesc: "Trạng thái người lái",
    analyticsDesc: "Thống kê chuyến đi",
    dataCollectionDesc: "Quản lý dataset",
    aiAssistantDesc: "Hỏi đáp thông minh",
  ...
  home: {
    ...
    heroTagline:
      "Phát hiện & cảnh báo với AI — an toàn hành trình mọi lúc, tối ưu cho giám sát phương tiện và người lái.",
    heroBadgeFaceRecog: "Nhận diện khuôn mặt",
    heroBadgeEdgeAI: "AI Edge Processing",
    heroBadgeVideoAnalysis: "Phân tích video",
    startDetection: "BẮT ĐẦU PHÁT HIỆN",
    aiAccuracyStat: "AI 97.3% độ chính xác thực nghiệm",
    radarTracking: "Radar Tracking",
    radarAiAcc: "AI: 97.3% acc",
    objectCount: "14 đối tượng",
    vehiclesFallback: "Xe cộ",
    pedestriansFallback: "Người đi bộ",
    tooltipQuantity: "Số lượng",
    ...
    viewAll: "Xem Tất Cả",
    monitorDriving: "Giám Sát Lái Xe",
    monitorDrivingDesc: "Theo dõi quá trình lái xe",
    ...
    detectionDistribution: "Phân Bố Phát Hiện Hiện Tại",
    detectionDistributionDesc: "Phân tích phát hiện hiện tại",
    systemPerformance: "Hiệu Suất Hệ Thống Theo Thời Gian",
  ...
  analytics: {
    ...
    timeMinutes: "{n} phút",
    timeHours: "{h} giờ",
    timeHoursMinutes: "{h} giờ {m} phút",
    trips: "{n} chuyến",
    loadingData: "Đang tải dữ liệu...",
    apiError: "Lỗi khi gọi API. Kiểm tra console.",
  },
  ...
  // ADAS Video Analysis
  adas: {
    title: "PHÂN TÍCH VIDEO LÁI XE",
    titleShort: "PHÂN TÍCH ADAS",
    subtitle: "Upload video để giám sát lái xe.",
    ...
    step1Desc: "Upload video từ máy của bạn để phân tích",
    status: "Trạng thái",
    ...
    storageProcessTitle: "QUY TRÌNH PHÂN TÍCH",
    storageProcessDesc: "Video sẽ được gửi tới AI để phân tích chi tiết.",
    step1Process: "Gửi video tới AI",
    step2Process: "AI phân tích nội dung video và trích xuất thông tin",
    step3Process: "Hiển thị kết quả phân tích để bạn tham khảo",
    step2Title: "2) XEM VIDEO ĐANG ĐƯỢC PHÂN TÍCH",
    sampleDataSaved: "Dữ liệu đã được lưu mẫu",
    step2Desc:
      "Video sẽ được gửi tới AI để phân tích và hiển thị kết quả cho bạn.",
    ...
    noVideoMessage: "Chưa có video. Vui lòng upload một video để bắt đầu.",
    analyzeAnotherVideo: "Phân tích video khác",
    dataWillBeSaved:
      "Dữ liệu sau phân tích chỉ được sử dụng trong phiên làm việc hiện tại để hiển thị kết quả cho bạn.",
    completed: "Đã xong",
  ...
  driverMonitor: {
    ...
    titleShort: "TÀI XẾ",
    subtitle: "Upload video để giám sát tài xế.",
    ...
    uploadRequiredDesc: "Vui lòng upload video để bắt đầu giám sát tài xế.",
