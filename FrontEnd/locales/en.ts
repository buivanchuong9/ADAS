export default {
  ...
  nav: {
    ...
    adasMonitorDesc: "Journey analysis",
    driverMonitorDesc: "Driver status",
    analyticsDesc: "Trip statistics",
    dataCollectionDesc: "Dataset management",
    aiAssistantDesc: "Smart QA & advice",
  ...
  home: {
    ...
    heroTagline:
      "AI-powered detection & alerts — journey safety at all times, optimized for vehicle and driver monitoring.",
    heroBadgeFaceRecog: "Face Recognition",
    heroBadgeEdgeAI: "AI Edge Processing",
    heroBadgeVideoAnalysis: "Video Analysis",
    startDetection: "START DETECTION",
    aiAccuracyStat: "AI 97.3% experimentally verified accuracy",
    radarTracking: "Radar Tracking",
    radarAiAcc: "AI: 97.3% acc",
    objectCount: "14 objects",
    vehiclesFallback: "Vehicles",
    pedestriansFallback: "Pedestrians",
    ...
    viewAll: "View All",
    monitorDriving: "Monitor Driving",
    monitorDrivingDesc: "Track driving process",
    ...
    detectionDistribution: "Current Detection Distribution",
    detectionDistributionDesc: "Current detection breakdown",
    systemPerformance: "System Performance Over Time",
  ...
  analytics: {
    ...
    timeHours: "{h} hours",
    timeHoursMinutes: "{h} hours {m} minutes",
    trips: "{n} trips",
    loadingData: "Loading data...",
    apiError: "API error. Check console.",
  },
  ...
  // ADAS Video Analysis
  adas: {
    title: "DRIVING VIDEO ANALYSIS",
    titleShort: "DRIVING ANALYSIS",
    subtitle: "Upload videos to monitor the driving process.",
    ...
    step1Desc: "Upload a video from your device for analysis",
    status: "Status",
    analyzing: "Analyzing",
    ready: "Ready",
    notReady: "Not Ready",
    ...
    storageProcessTitle: "ANALYSIS PROCESS",
    storageProcessDesc: "Video will be sent to AI for detailed analysis.",
    step1Process: "Send video to AI",
    step2Process: "AI analyzes video content and extracts information",
    step3Process: "Display analysis results for your review",
    step2Title: "2) VIEW VIDEO BEING ANALYZED",
    sampleDataSaved: "Sample data saved",
    step2Desc:
      "Video will be sent to AI for analysis and the results will be displayed for you.",
    ...
    noVideoMessage: "No video yet. Please upload a video to get started.",
    analyzeAnotherVideo: "Analyze Another Video",
    dataWillBeSaved:
      "Data after analysis is only used in the current session to show results to you.",
    completed: "Completed",
  ...
  driverMonitor: {
    ...
    titleShort: "DRIVER",
    subtitle: "Upload videos to monitor the driver.",
    ...
    uploadRequiredDesc: "Please upload a video to start driver monitoring.",
