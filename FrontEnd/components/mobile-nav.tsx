  ...
  const navigation = useMemo(
    () => [
      ...
      },
      {
        ...
        icon: Database,
        description: t("nav.dataCollectionDesc"),
      },
      {
    ...
    <>
      ...
      >
        <Button
          ...
          className="bg-transparent border-none shadow-none hover:bg-orange-50 active:bg-orange-100 text-orange-500"
        >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.aside
            ...
            className="lg:hidden fixed left-0 top-0 h-dvh w-64 flex flex-col relative overflow-hidden rounded-r-2xl z-50"
            style={{
          ...
          >
            ...
            <motion.div
              ...
              className="p-6 border-b relative z-10 shrink-0"
            ...
            >
              ...
              >
                <motion.div
                  className="w-24 h-24 rounded-2xl overflow-hidden shadow-lg ring-2 ring-offset-2 ring-[var(--primary)]"
            ...
            <nav className="flex-1 p-4 space-y-1 relative z-10 overflow-y-auto overscroll-contain touch-pan-y scroll-smooth">
            ...
            <motion.div
              ...
              className="p-4 border-t relative z-10 shrink-0"
              style={{ borderColor: "var(--border-subtle)" }}
            >
              <Link
                href="/settings"
