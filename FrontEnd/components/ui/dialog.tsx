  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          'fixed left-1/2 top-1/2 z-50 w-full max-w-[calc(100%-2rem)] sm:max-w-3xl -translate-x-1/2 -translate-y-1/2',
          'h-[80vh] max-h-[80vh] overflow-hidden flex flex-col gap-4',
