...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      "@container/card-header grid auto-rows-min grid-rows-[auto_auto] items-start gap-2 px-6 has-data-[slot=card-action]:grid-cols-[1fr_auto] [.border-b]:pb-6 text-black",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      "leading-none font-bold text-lg text-black",
      className
    )}
    {...props}
  />
