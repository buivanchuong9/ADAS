module.exports = [
"[project]/Desktop/AI/ADAS/FrontEnd/node_modules/.pnpm/highcharts@12.4.0/node_modules/highcharts/highcharts.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
 ...
 */ function(t, e) {
    ("TURBOPACK compile-time truthy", 1) ? (t._Highcharts = e(), module.exports = t._Highcharts) : "TURBOPACK unreachable";
}(("TURBOPACK compile-time truthy", 1) ? /*TURBOPACK member replacement*/ __turbopack_context__.e : "TURBOPACK unreachable", ()=>(()=>{
        "use strict";
        let t, e;
        ...
        v.d(k, {
            ...
            t.SVG_NS = "http://www.w3.org/2000/svg", t.product = "Highcharts", t.version = "12.4.0", t.win = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : {}, t.doc = t.win.document, t.svg = !!t.doc?.createElementNS?.(t.SVG_NS, "svg")?.createSVGRect, t.pageLang = t.doc?.documentElement?.closest("[lang]")?.lang, t.userAgent = t.win.navigator?.userAgent || "", t.isChrome = t.win.chrome, t.isFirefox = -1 !== t.userAgent.indexOf("Firefox"), t.isMS = /(edge|msie|trident)/i.test(t.userAgent) && !t.win.opera, t.isSafari = !t.isChrome && -1 !== t.userAgent.indexOf("Safari"), t.isTouchDevice = /(Mobile|Android|Windows Phone)/.test(t.userAgent), t.isWebKit = -1 !== t.userAgent.indexOf("AppleWebKit"), t.deg2rad = 2 * Math.PI / 360, t.marginNames = [
                "plotTop",
                "marginRight",
                "marginBottom",
                "plotLeft"
        ...
        function C(t, e, i, s) {
            ...
            let r = D(t), a = r ? `${o} #${t}: www.highcharts.com/errors/${t}/` : t.toString();
            if (void 0 !== s) {
                let t = "";
 ...
 - ${i}: ${e}`, r && (a += encodeURI(i) + "=" + encodeURI(e));
        ...
        let V = {
        ...
        }, { pageLang: Z, win: _ } = w, { defined: q, error: K, extend: J, isNumber: Q, isObject: tt, isString: te, merge: ti, objectEach: ts, pad: to, splat: tr, timeUnits: ta, ucfirst: tn } = V, th = w.isSafari && _.Intl && !_.Intl.DateTimeFormat.prototype.formatRange, tl = (t)=>void 0 === t.main, td = class {
            constructor(t, e){
                this.options = {
                    timezone: "UTC"
            ...
            update(t = {}) {
                ...
                let o = t.timezone;
                q(i) && (o = i ? "UTC" : void 0), e && e % 60 == 0 && (o = "Etc/GMT" + (e > 0 ? "+" : "") + e / 60), this.variableTimezone = "UTC" !== o && o?.indexOf("Etc/GMT") !== 0, this.timezone = o, this.lang && s && (this.lang.locale = s), [
                    "months",
                    "shortMonths",
                    "weekdays",
                    "shortWeekdays"
        ...
        }, { isTouchDevice: tf } = w, { fireEvent: tm, merge: tx } = V, ty = {
            colors: [
                "#2caffe",
                "#544fc5",
                "#00e272",
        ...
        }, { win: tk } = w, { isNumber: tw, isString: tM, merge: tS, pInt: tT, defined: tC } = V, tA = (t, e, i)=>`color-mix(in srgb,${t},${e} ${100 * i}%)`, tP = (t)=>tM(t) && !!t && "none" !== t;
        class tL {
            static parse(t) {
            ...
            constructor(t){
                ...
                if ("object" == typeof t && void 0 !== t.stops) this.stops = t.stops.map((t)=>new tL(t[1]));
                else if ("string" == typeof t) for(this.input = t = tL.names[t.toLowerCase()] || t, s = tL.parsers.length; s-- && !i;)(e = (o = tL.parsers[s]).regex.exec(t)) && (i = o.parse(e));
                i && (this.rgba = i);
            }
            get(t) {
            ...
            brighten(t) {
                ...
                else if (tw(t) && 0 !== t) if (tw(e[0])) for(let i = 0; i < 3; i++)e[i] += tT(255 * t), e[i] < 0 && (e[i] = 0), e[i] > 255 && (e[i] = 255);
                else tL.useColorMix && tP(this.input) && (this.output = tA(this.input, t > 0 ? "white" : "black", Math.abs(t)));
                return this;
            }
            setOpacity(t) {
        ...
        class tB {
            ...
            initPath(t, e, i) {
                ...
                return g.length && tI(l) && (d = r.length + l * n, p ? (u(g, r), f(r)) : (u(r, g), f(g))), [
                    g,
                    r
                ];
            }
        ...
        let tU = {
            ...
            stop: tY
        }, { SVG_NS: t$, win: tV } = w, { attr: tZ, createElement: t_, css: tq, error: tK, isFunction: tJ, isString: tQ, objectEach: t0, splat: t1 } = V, { trustedTypes: t2 } = tV, t3 = t2 && tJ(t2.createPolicy) && t2.createPolicy("highcharts", {
            createHTML: (t)=>t
        }), t5 = t3 ? t3.createHTML("") : "";
        class t6 {
            static filterUserAttributes(t) {
                return t0(t, (e, i)=>{
                    let s = !0;
                    -1 === t6.allowedAttributes.indexOf(i) && (s = !1), -1 !== [
                        "background",
                        "dynsrc",
                        "href",
                        "lowsrc",
                        "src"
                    ].indexOf(i) && (s = tQ(e) && t6.allowedReferences.some((t)=>0 === e.indexOf(t))), s || (tK(33, !1, void 0, {
                ...
                return function t(e, i) {
                    ...
                    return t1(e).forEach(function(e) {
                        ...
                        if (r) if ("#text" === r) o = a;
                            ...
                            let s = "svg" === r ? t$ : i.namespaceURI || t$, h = w.doc.createElementNS(s, r), l = e.attributes || {};
                            t0(e, function(t, e) {
        ...
        t6.allowedAttributes = [
            ...
            "u",
            "ul"
        ], t6.emptyHTML = t5, t6.bypassHTMLFiltering = !1;
        let { defaultOptions: t9, defaultTime: t4 } = tv, { pageLang: t8 } = w, { extend: t7, getNestedProperty: et, isArray: ee, isNumber: ei, isObject: es, isString: eo, pick: er, ucfirst: ea } = V, en = {
            add: (t, e)=>t + e,
            divide: (t, e)=>0 !== e ? t / e : "",
            eq: (t, e)=>t == e,
            each: function(t) {
        ...
        function ed(t = "", e, i) {
            ...
            return r.forEach((s)=>{
                ...
                if (m) {
                    ...
                    let t = el(f) ? [
                        f
                    ] : f.split(":"), e = (r = c(t.shift() || "")) % 1 != 0;
                    if ("number" == typeof r && (t.length || e)) {
                        let i = t.join(":");
                        if (a.test(i) || e) {
                            let t = parseInt((i.match(n) || [
                                "",
                                "-1"
                            ])[1], 10);
        ...
        function ec(t, e, i, s) {
            ...
            let p = s || i, g = p ? "en" : this?.locale || h.locale || t8, u = JSON.stringify(c) + g;
        ...
        class eK {
            ...
            align(t, e, i, s = !0) {
                ...
                let h = eU(i, o[n], o), l = (h.x || 0) + (t.x || 0) + ((h.width || 0) - (t.width || 0)) * eR(t.align), d = (h.y || 0) + (t.y || 0) + ((h.height || 0) - (t.height || 0)) * eR(t.verticalAlign), c = {
                    "text-align": t?.align
                };
            ...
            animate(t, e, i) {
                let s = ev(eU(e, this.renderer.globalAnimation, !0)), o = s.defer;
            ...
            clip(t) {
                if (t && !t.clipPath) {
                    let e = eq() + "-", i = this.renderer.createElement("clipPath").attr({
                        id: e
            ...
            crisp(t, e) {
                ...
                let i = t.x || this.x || 0, s = t.y || this.y || 0, o = (t.width || this.width || 0) + i, r = (t.height || this.height || 0) + s, a = eE(i, e), n = eE(s, e);
                return eN(t, {
                    x: a,
                    y: n,
                    width: eE(o, e) - a,
            ...
            css(t) {
                ...
                if (e && eY(t, function(t, s) {
                    ...
                    s.namespaceURI === this.SVG_NS && ([
                        ...
                        "whiteSpace",
                        "width"
                    ].forEach((t)=>a && delete a[t]), a.color && (a.fill = a.color, delete a.color)), eI(s, a);
                }
            ...
            getBBox(t, e) {
                ...
                if (eD(d) && (-1 === (r = d.toString()).indexOf("<") && (r = r.replace(/\d/g, "0")), r += [
                    "",
                    h.rootFontSize,
                    f,
                    u,
            ...
            getRotatedBox(t, e) {
                let { x: i, y: s, width: o, height: r } = t, { alignValue: a, translateY: n, rotationOriginX: h = 0, rotationOriginY: l = 0 } = this, d = eR(a), c = Number(this.element.getAttribute("y") || 0) - (n ? 0 : s), p = e * ew, g = (e - 90) * ew, u = Math.cos(p), f = Math.sin(p), m = o * u, x = o * f, y = Math.cos(g), b = Math.sin(g), [[v, k], [w, M]] = [
                    h,
                    l
                ].map((t)=>[
                        t - t * u,
            ...
            shadow(t) {
                let { renderer: e } = this, i = ej(this.parentGroup?.rotation === 90 ? {
                    offsetX: -1,
                    offsetY: -1
                } : {}, eF(t) ? t : {}), s = e.shadowDefinition(i);
                return this.attr({
            ...
            titleSetter(t) {
                let e = this.element, i = e.getElementsByTagName("title")[0] || eM.createElementNS(this.SVG_NS, "title");
                e.insertBefore ? e.insertBefore(i, e.firstChild) : e.appendChild(i), i.textContent = eZ(eU(t, ""), [
                    /<[^>]*>/g,
                    ""
                ]).replace(/&lt;/g, "<").replace(/&gt;/g, ">");
            }
            ...
            updateTransform(t = "transform") {
                let { element: e, foreignObject: i, matrix: s, padding: o, rotation: r = 0, rotationOriginX: a, rotationOriginY: n, scaleX: h, scaleY: l, text: d, translateX: c = 0, translateY: p = 0 } = this, g = [
                    "translate(" + c + "," + p + ")"
                ];
        ...
        class e9 extends eJ {
            ...
            getBBox(t, e) {
                ...
                let { padding: i, height: s = 0, translateX: o = 0, translateY: r = 0, width: a = 0 } = this, n = e5(this.paddingLeft, i), h = e ?? (this.rotation || 0), l = {
                    width: a,
                    height: s,
                    x: o + this.bBox.x - n,
            ...
            updateTextPadding() {
                ...
                if (!t.textPath) {
                    this.updateBoxSize();
                    let i = this.baseline ? 0 : this.baselineOffset, s = (this.paddingLeft ?? this.padding) + e1(e) * (this.widthSetting ?? this.bBox.width);
                    (s !== t.x || i !== t.y) && (t.attr({
                        align: e,
                        x: s
            ...
            getPaddedWidth() {
                let t = this.padding, e = e5(this.paddingLeft, t), i = e5(this.paddingRight, t);
        ...
        function it(t, e, i, s, o) {
            let r = [];
            if (o) {
                let a = o.start || 0, n = o.end || 0, h = e7(o.r, i), l = e7(o.r, s || i), d = 2e-4 / (o.borderRadius ? 1 : Math.max(h, 1)), c = Math.abs(n - a - 2 * Math.PI) < d;
                c && (a = Math.PI / 2, n = 2.5 * Math.PI - d);
                let p = o.innerR, g = e7(o.open, c), u = Math.cos(a), f = Math.sin(a), m = Math.cos(n), x = Math.sin(n), y = e7(o.longArc, n - a - Math.PI < d ? 0 : 1), b = [
                    "A",
                    h,
                    l,
                    0,
        ...
        let is = {
            ...
            callout: function(t, e, i, s, o) {
                let r = Math.min(o?.r || 0, i, s), a = r + 6, n = o?.anchorX, h = o?.anchorY || 0, l = ii(t, e, i, s, {
                    r
                });
        ...
        }, { doc: io, SVG_NS: ir, win: ia } = w, { attr: ih, extend: il, fireEvent: id, isString: ic, objectEach: ip, pick: ig } = V, iu = (t, e)=>t.substring(0, e) + "…", im = class {
            constructor(t){
                let e = t.styles;
            ...
            buildSVG() {
                let t = this.svgElement, e = t.element, i = t.renderer, s = ig(t.textStr, "").toString(), o = -1 !== s.indexOf("<"), r = e.childNodes, a = !t.added && i.box, n = [
                    s,
                    this.ellipsis,
                    this.noWrap,
                    this.textLineHeight,
        ...
        class iU {
            ...
            getReferenceURL() {
                if ((ik || iM) && iv.getElementsByTagName("base").length) {
                    ...
                    if (e) return ij(iA.location.href.split("#")[0], [
                        /<[^>]*>/g,
                        ""
                    ], [
                        /([\('\)])/g,
            ...
            shadowDefinition(t) {
                ...
                ].join("-").toLowerCase().replace(/[^a-z\d\-]/g, ""), i = iX({
                    color: "#000000",
                    offsetX: 1,
                    offsetY: 1,
                    opacity: .15,
            ...
            getContrast(t) {
                ...
                let e = tL.parse(t).rgba, i = " clamp(0,calc(9e9*(0.5 - (0.2126*r + 0.7152*g + 0.0722*b))),1)";
            ...
            fontMetrics(t) {
                let e = iR(t) ? t : iG(eJ.prototype.getStyle.call(t, "font-size") || 0), i = e < 24 ? e + 3 : Math.round(1.2 * e), s = Math.round(.8 * i);
                return {
                    h: i,
                    b: s,
                    f: e
        ...
        let i5 = (t, e)=>{
            if (!t.div) {
                let i = iZ(t.element, "class"), s = t.css, o = iq("div", i ? {
                    className: i
                } : void 0, {
                    position: "absolute",
            ...
            updateTransform() {
                ...
                if (e || i_(t, {
                    ...
                    let g, u = [
                        ...
                        p,
                        this.textAlign
                    ].join(","), x = -(this.parentGroup?.padding * 1) || 0;
                    if (p !== i) {
                        let e = this.textPxLength ? this.textPxLength : (i_(t, {
                            width: "",
                            whiteSpace: d || "nowrap"
                        }), t.offsetWidth), r = p || 0, a = !s.styledMode && "" === t.style.textOverflow && t.style.webkitLineClamp;
                    ...
                    let { xCorr: y = 0, yCorr: b = 0 } = this, v = {
                        left: `${f + y}px`,
                        top: `${m + b}px`,
                        textAlign: c,
        ...
        let si = a, { deg2rad: ss } = w, { clamp: so, correctFloat: sr, defined: sa, destroyObjectProperties: sn, extend: sh, fireEvent: sl, getAlignFactor: sd, isNumber: sc, merge: sp, objectEach: sg, pick: su } = V, sf = class {
            ...
            addLabel() {
                ...
                let v = (t)=>h.formatter ? h.formatter.call(t, t) : h.format ? (t.text = e.defaultLabelFormatter.call(t), ep.format(h.format, t, s)) : e.defaultLabelFormatter.call(t), k = v.call(b, b), w = m?.list;
            ...
            createLabel(t, e, i) {
                let s = this.axis, { renderer: o, styledMode: r } = s.chart, a = e.style.whiteSpace, n = sa(t) && e.enabled ? o.text(t, i?.x, i?.y, e.useHTML).add(s.labelGroup) : void 0;
            ...
            getLabelPosition(t, e, i, s, o, r, a, n) {
                ...
                return h = 0 === d.side ? i.rotation ? -m : -i.getBBox().height : 2 === d.side ? u.y + m : Math.cos(i.rotation * ss) * (u.y - i.getBBox(!1, 0).height / 2), sa(o.y) && (h = 0 === d.side && d.horiz ? o.y + h : o.y), t = t + su(o.x, [
                    0,
                    1,
                    0,
                    -1
                ][d.side] * m) + f + u.x - (r && s ? r * c * (p ? -1 : 1) : 0), e = e + h - (r && !s ? r * c * (p ? 1 : -1) : 0), g && (l = a / (n || 1) % g, d.opposite && (l = g - l - 1), e += l * (d.labelOffset / g)), x.x = t, x.y = Math.round(e), sl(this, "afterGetLabelPosition", {
                    pos: x,
                    tickmarkOffset: r,
                    index: a
                }), x;
            ...
            render(t, e, i) {
                let s = this.axis, o = s.horiz, r = this.pos, a = su(this.tickmarkOffset, s.tickmarkOffset), n = this.getPosition(o, r, a, e), h = n.x, l = n.y, d = s.pos, c = d + s.len, p = o ? h : l, g = su(i, this.label?.newOpacity, 1);
            ...
            renderMark(t, e) {
                let i = this.axis, s = i.options, o = i.chart.renderer, r = this.type, a = i.tickSize(r ? r + "Tick" : "tick"), n = t.x, h = t.y, l = su(s["minor" !== r ? "tickWidth" : "minorTickWidth"], !r && i.isXAxis ? 1 : 0), d = s["minor" !== r ? "tickColor" : "minorTickColor"], c = this.mark, p = !c;
            ...
            renderLabel(t, e, i, s) {
                let o = this.axis, r = o.horiz, a = o.options, n = this.label, h = a.labels, l = h.step, d = su(this.tickmarkOffset, o.tickmarkOffset), c = t.x, p = t.y, g = !0;
        ...
        class s$ {
            ...
            getPlotLinePath(t) {
                ...
                return sE(this, "getPlotLinePath", b, function(t) {
                    g = f = (c = sS(c = sX(c, e.translate(a, void 0, void 0, r)), -1e9, 1e9)) + d, u = m = h - c - d, sN(c) ? e.horiz ? (u = o, m = h - e.bottom + (e.options.isInternal ? 0 : i.scrollablePixelsY || 0), g = f = y(g, s, s + e.width)) : (g = s, f = l - e.right + (i.scrollablePixelsX || 0), u = m = y(u, o, o + e.height)) : (x = !0, p = !1), t.path = x && !p ? void 0 : i.renderer.crispLine([
                        [
                            "M",
                            g,
                            u
            ...
            getLinearTickPositions(t, e, i) {
                ...
                if (sT(a + t) === a && (r = 20), this.single) return [
                    e
                ];
            ...
            adjustForMinRange() {
                ...
                })) || 0), this.dataMax - this.dataMin)), sN(s) && sN(o) && sN(r) && s - o < r && (n = this.dataMax - this.dataMin >= r, a = (r - s + o) / 2, h = [
                    o - a,
                    i.parse(t.min) ?? o - a
                ], n && (h[2] = e ? e.log2lin(this.dataMin) : this.dataMin), l = [
                    (o = sw(h)) + r,
                    i.parse(t.max) ?? o + r
                ], n && (l[2] = e ? e.log2lin(this.dataMax) : this.dataMax), (s = sM(l)) - o < r && (h[0] = s - r, h[1] = i.parse(t.min) ?? s - r, o = sw(h))), this.minRange = r, this.min = o, this.max = s;
            }
            getClosest() {
                let t, e;
            ...
            setAxisTranslation() {
                ...
                (o || s || r) && (a = t.getClosest(), i ? (n = i.minPointOffset, h = i.pointRangePadding) : t.series.forEach(function(e) {
                    let i = s ? 1 : o ? sX(e.options.pointRange, a, 0) : t.axisPointRange || 0, l = e.options.pointPlacement;
            ...
            setTickPositions() {
                ...
                if (this.tickmarkOffset = this.categories && "between" === t.tickmarkPlacement && 1 === this.tickInterval ? .5 : 0, this.single = this.min === this.max && sC(this.min) && !this.tickAmount && (this.min % 1 == 0 || !1 !== t.allowDecimals), e) n = e.slice();
                    ...
                    if (!this.ordinal?.positions && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200)) n = [
                        ...
                        for(; e <= 2 * t;)if (n = this.getLinearTickPositions(this.tickInterval, this.min, this.max), this.tickAmount && n.length > this.tickAmount) this.tickInterval = sU(this, e *= 1.1);
                        else break;
                    }
                    n.length > this.len && (n = [
                        n[0],
            ...
            adjustTickAmount() {
                let t = this, { finalTickAmt: e, max: i, min: s, options: o, tickPositions: r, tickAmount: a, thresholdAlignment: n } = t, h = r?.length, l = sX(t.threshold, t.softThreshold ? 0 : null), d, c, p = t.tickInterval, g, u = ()=>r.push(sT(r[r.length - 1] + p)), f = ()=>r.unshift(sT(r[0] - p));
            ...
            setAxisSize() {
                let t = this.chart, e = this.options, i = e.offsets || [
                    ...
                    0,
                    0
                ], s = this.horiz, o = this.width = Math.round(sF(sX(e.width, t.plotWidth - i[3] + i[1]), t.plotWidth)), r = this.height = Math.round(sF(sX(e.height, t.plotHeight - i[0] + i[2]), t.plotHeight)), a = this.top = Math.round(sF(sX(e.top, t.plotTop + i[0]), t.plotHeight, t.plotTop)), n = this.left = Math.round(sF(sX(e.left, t.plotLeft + i[3]), t.plotWidth, t.plotLeft));
            ...
            autoLabelAlign(t) {
                let e = (sX(t, 0) - 90 * this.side + 720) % 360, i = {
                    align: "center"
                };
            ...
            tickSize(t) {
                let e = this.options, i = sX(e["tick" === t ? "tickWidth" : "minorTickWidth"], "tick" === t && this.isXAxis && !this.categories ? 1 : 0), s = e["tick" === t ? "tickLength" : "minorTickLength"], o;
            ...
            getOffset() {
                let t = this, { chart: e, horiz: i, options: s, side: o, ticks: r, tickPositions: a, coll: n } = t, h = e.inverted && !t.isZAxis ? [
                    ...
                    3,
                    2
                ][o] : o, l = t.hasData(), d = s.title, c = s.labels, p = sN(s.crossing), g = e.axisOffset, u = e.clipOffset, f = [
                    -1,
                    1,
                    1,
                    -1
        ...
        !function(t) {
            ...
            class s {
                ...
                normalizeTimeTickInterval(t, e) {
                    ...
                    ], s = i[i.length - 1], o = sq[s[0]], r = s[1], a;
        ...
        class oO {
            ...
            getAnchor(t, e) {
                ...
                if (t = oP(t), t[0].series?.yAxis && !t[0].series.yAxis.options.reversedStacks && (t = t.slice().reverse()), this.followPointer && e) void 0 === e.chartX && (e = o.normalize(e)), i = [
                    e.chartX - n,
                    e.chartY - a
                ];
            ...
            getLabel({ anchorX: t, anchorY: e } = {
                ...
                if (!this.label) {
                    if (this.outside) {
                        let t = this.chart, e = t.options.chart.style, i = eg.getRendererType();
            ...
            getPlayingField() {
                let { body: t, documentElement: e } = oc, { chart: i, distance: s, outside: o } = this;
                return {
            ...
            getPosition(t, e, i) {
                ...
                let T = !this.followPointer && oC(i.ttBelow, !d && !n === S), C = function(t, e, i, o, a, n, h) {
            ...
            move(t, e, i, s) {
                let { followPointer: o, options: r } = this, a = on(!o && !this.isHidden && !r.fixed && r.animation), n = o || (this.len || 0) > 1, h = {
                    x: t,
                    y: e
                };
            ...
            refresh(t, e) {
                let { chart: i, options: s, pointer: o, shared: r } = this, a = oP(t), n = a[0], h = s.format, l = s.formatter || this.defaultFormatter, d = i.styledMode, c = this.allowShared;
            ...
            renderSplit(t, e) {
                let i = this, { chart: s, chart: { chartWidth: o, chartHeight: r, plotHeight: a, plotLeft: n, plotTop: h, scrollablePixelsY: l = 0, scrollablePixelsX: d, styledMode: c }, distance: p, options: g, options: { fixed: u, position: f, positioner: m }, pointer: x } = i, { scrollLeft: y = 0, scrollTop: b = 0 } = s.scrollablePlotArea?.scrollingContainer || {}, v = i.outside && "number" != typeof d ? oc.documentElement.getBoundingClientRect() : {
                    left: y,
                    right: y + o,
                    top: b,
                    bottom: b + r
                }, k = i.getLabel(), w = this.renderer || s.renderer, M = !!s.xAxis[0]?.opposite, { left: S, top: T } = x.getChartPosition(), C = m || u, A = h + b, P = 0, L = a - l, O = function(t, e, s, o = [
                    0,
                    0
                ], r = !0) {
                    let a, n;
                    if (s.isHeader) n = M ? 0 : L, a = of(o[0] - t / 2, v.left, v.right - t - (i.outside ? S : 0));
                    else if (u && s) {
                ...
                let E = t.slice(0, e.length + 1).reduce(function(t, s, o) {
                    if (!1 !== s && "" !== s) {
                        let r = e[o - 1] || {
                            ...
                            let o = t, { isHeader: r, series: a } = e, n = a.tooltipOptions || g;
                            if (!o) {
                                let t = {
                                    padding: n.padding,
                                    r: n.borderRadius
                        ...
                        if ("number" == typeof S) {
                            let e = x.height + 1, s = (m || O).call(i, y, e, r, [
                                b,
                                S
                            ]);
                            t.push({
                ...
                !C && E.some((t)=>{
                    ...
                    let { x: e, y: i } = O.call(this, t.boxWidth, t.size, t.point, [
                        t.anchorX,
                        t.anchorY
                    ], !1);
                    return oy(t, {
        ...
        class oq {
            ...
            destroy() {
                if (!this.destroyed) {
                    let t = this, e = t.series, i = e.chart, s = e.options.dataSorting, o = i.hoverPoints, r = oI(t.series.chart.renderer.globalAnimation), a = ()=>{
            ...
            optionsToObject(t) {
                ...
                else if (oF(t)) for(!i && t.length > o && ("string" == (a = typeof t[0]) ? e.xAxis?.dateTime ? r.x = e.chart.time.parse(t[0]) : r.name = t[0] : "number" === a && (r.x = t[0]), n++); h < o;)i && void 0 === t[n] || (s[h].indexOf(".") > 0 ? oq.prototype.setNestedProperty(r, t[n], s[h]) : r[s[h]] = t[n]), n++, h++;
            ...
            pos(t, e = this.plotY) {
                if (!this.destroyed) {
                    ...
                    if (oj(i) && oj(e)) return t && (n = r ? r.pos : o.plotLeft, h = a ? a.pos : o.plotTop), o.inverted && r && a ? [
                        a.len - e + h,
                        r.len - i + n
                    ] : [
                        i + n,
            ...
            manageEvent(t) {
                let e = oU(this.series.options.point, this.options), i = e.events?.[t];
        ...
        class rr {
            ...
            getChartPosition() {
                ...
                let { container: t } = this.chart, e = re(t);
                this.chartPosition = {
                    left: e.left,
                    top: e.top,
                    scaleX: 1,
            ...
            getHoverData(t, e, i, s, o, r) {
                ...
                o4(this, "beforeGetHoverData", d), l = h && !h.stickyTracking ? [
                    h
                ...
                return h = c?.series, c && (o && !h.noSharedTooltip ? (l = i.filter(function(t) {
                    ...
                    let e = t.options?.nullInteraction, i = o9(t.points, function(t) {
            ...
            normalize(t, e) {
                let i = t.touches, s = i ? i.length ? i.item(0) : ri(i.changedTouches, t.changedTouches)[0] : t;
            ...
            pinch(t) {
                let e = this, { chart: i, hasZoom: s, lastTouches: o } = e, r = [].map.call(t.touches || [], (t)=>e.normalize(t)), a = r.length, n = 1 === a && (e.inClass(t.target, "highcharts-tracker") && i.runTrackerClick || e.runChartClick), h = i.tooltip, l = 1 === a && ri(h?.options.followTouchMove, !0);
            ...
            setPointerCapture() {
                if (!o1) return;
                let t = this.pointerCaptureEventsToUnbind, e = this.chart, i = e.container, s = ri(e.options.tooltip?.followTouchMove, !0) && e.series.some((t)=>t.options.findNearestPointBy.indexOf("y") > -1);
            ...
            setHoverChartIndex(t) {
                let e = this.chart, i = w.charts[ri(rr.hoverChartIndex, -1)];
                if (i && i !== e) {
                    let s = {
        ...
        !function(t) {
            function e(e, i) {
                let s = rx.plotOptions || {}, o = i.defaultOptions, r = i.prototype;
        ...
        class r0 {
            ...
            setOptions(t) {
                ...
                let h = n.plotOptions[this.type], l = o.plotOptions || {}, d = l.series || {}, c = rS.plotOptions[this.type] || {}, p = l[this.type] || {};
            ...
            updateData(t, e) {
                ...
                }, this), h) for(l = r.length; l--;)(d = r[l]) && !d.touched && d.remove?.(!1, e);
            ...
            setData(t, e = !0, i, s) {
                ...
                if (h?.enabled && (t = this.sortData(t)), n.options.chart.allowMutatingData && !1 !== s && k && r && !this.cropped && !this.hasGroupedData && this.visible && !this.boosted && (x = this.updateData(t, i)), !x) {
                    ...
                    if (e) {
                        let i = this.getFirstValidPoint(t), s = this.getFirstValidPoint(t, k - 1, -1), o = (t)=>!!(r$(t) && (f || rV(t[0])));
                        if (rV(i) && rV(s)) {
                            let e = [], i = [];
                        ...
                        } else if (o(i) && o(s)) if (u) {
                            let e = +(i.length === u), s = Array(p.length).fill(0).map(()=>[]);
                            for (let i of t){
            ...
            generatePoints() {
                let t = this.options, e = this.processedData || t.data, i = this.dataTable.modified, s = this.getColumn("x", !0), o = this.pointClass, r = i.rowCount, a = this.cropStart || 0, n = this.hasGroupedData, h = t.keys, l = [], d = t.dataGrouping?.groupAll ? a : 0, c = this.xAxis?.categories, p = this.pointArrayMap || [
                    "y"
            ...
            animate(t) {
                let { chart: e, group: i, markerGroup: s } = this, o = e.inverted, r = rw(this.options.animation), a = [
            ...
            render() {
                let t = this, { chart: e, options: i, hasRendered: s } = t, o = rw(i.animation), r = t.visible ? "inherit" : "hidden", a = i.zIndex, n = e.seriesGroup, h = t.finishedAnimating ? 0 : o.duration;
            ...
            searchKDTree(t, e, i, s, o) {
                ...
                if (this.kdTree || this.buildingKdTree || this.buildKDTree(i), this.kdTree) return function t(e, i, s, o) {
                    ...
                    !function(t, e) {
                        let i = t[a], s = e[a], o = rN(i) && rN(s) ? i - s : null, r = t[n], h = e[n], l = rN(r) && rN(h) ? r - h : 0, c = d && e.marker?.radius || 0;
            ...
            drawTracker() {
                ...
                }, l = "rgba(192,192,192," + (rC ? 1e-4 : .002) + ")", d = t.tracker;
                d ? d.attr({
                    d: s
            ...
            update(t, e) {
                ...
                let i = this, s = i.chart, o = i.userOptions, r = i.initialType || i.type, a = s.options.plotOptions, n = rP[r].prototype, h = i.finishedAnimating && {
                    animation: !1
                }, l = {}, d, c, p = r0.keepProps.slice(), g = t.type || o.type || s.options.chart.type, u = !(this.hasDerivedData || g && g !== this.type || void 0 !== t.keys || void 0 !== t.pointStart || void 0 !== t.pointInterval || void 0 !== t.relativeXValue || t.joinBy || t.mapData || [
                    "dataGrouping",
                    "pointStart",
                    "pointInterval",
                    "pointIntervalUnit",
                ...
                let f = !1;
                if (rP[g]) {
                    if (f = g !== i.type, i.remove(!1, !1, !1, !0), f) if (s.propFromSeries(), Object.setPrototypeOf) Object.setPrototypeOf(i, rP[g].prototype);
                    else {
            ...
            hasOptionChanged(t) {
                let e = this.chart, i = this.options[t], s = e.options.plotOptions, o = this.userOptions[t], r = rK(s?.[this.type]?.[t], s?.series?.[t]);
            ...
            setState(t, e) {
                let i = this, s = i.options, o = i.graph, r = s.inactiveOtherPoints, a = s.states, n = rK(a[t || "normal"] && a[t || "normal"].animation, i.chart.options.chart.animation), h = s.lineWidth, l = s.opacity;
                if (t = t || "", i.state !== t && ([
                    i.group,
                    i.markerGroup,
                    i.dataLabelsGroup
                    ...
                    if (t && (h = a[t].lineWidth || h + (a[t].lineWidthPlus || 0), l = rK(a[t].opacity, l)), o && !o.dashstyle && rV(h)) for (let t of [
                        o,
        ...
        }, r0.types = rk.seriesTypes, r0.registerType = rk.registerSeriesType, r0.keepProps = [
            "colorIndex",
            "eventOptions",
            "navigatorSeries",
            "symbolIndex",
        ...
        class ag {
            ...
            layoutItem(t) {
                let e = this.options, i = this.padding, s = "horizontal" === e.layout, o = t.itemHeight, r = this.itemMarginBottom, a = this.itemMarginTop, n = s ? ah(e.itemDistance, 20) : 0, h = this.maxLegendWidth, l = e.alignColumns && this.totalItemWidth > h ? this.maxItemWidth : t.itemWidth, d = t.legendItem || {};
            ...
            adjustMargins(t, e) {
                ...
                o && [
                    ...
                    r.test(o) && !ai(t[a]) && (i[r9[a]] = Math.max(i[r9[a]], i.legend[(a + 1) % 2 ? "legendHeight" : "legendWidth"] + [
                        1,
                        -1,
                        -1,
                        1
            ...
            render() {
                ...
                this.itemX = s, this.itemY = this.initialItemY, this.offsetWidth = 0, this.lastItemY = 0, this.widthOption = ad(i.width, t.spacingBox.width - s), l = t.spacingBox.width - 2 * s - i.x, [
                    "rm",
                    "lm"
            ...
            setItemEvents(t, e, i) {
                let s = this, o = t.legendItem || {}, r = s.chart.renderer.boxWrapper, a = t instanceof oK, n = t instanceof r1, h = "highcharts-legend-" + (a ? "point" : "series") + "-active", l = s.chart.styledMode, d = i ? [
                    e,
                    o.symbol
                ] : [
                    o.group
        ...
        class a0 {
            ...
            init(t, e) {
                aW(this, "init", {
                    ...
                    let i = aU(ay, t), s = i.chart, o = this.renderTo || s.renderTo;
            ...
            initSeries(t) {
                let e = this.options.chart, i = t.type || e.type, s = aC[i];
                s || aN(17, !0, this, {
                    missingModuleFor: i
                });
                let o = new s;
            ...
            orderItems(t, e = 0) {
                let i = this[t], s = this.options[t] = aK(this.options[t]).slice(), o = this.userOptions[t] = this.userOptions[t] ? aK(this.userOptions[t]).slice() : [];
            ...
            getClipBox(t, e) {
                let i = this.inverted, { xAxis: s, yAxis: o } = t || {}, { x: r, y: a, width: n, height: h } = aU(this.clipBox);
            ...
            applyDescription(t, e) {
                let i = this, s = this.options[t] = aU(this.options[t], e), o = this[t];
            ...
            layOutTitles(t = !0) {
                ...
                [
                    ...
                    let i = this[t], r = this.options[t], a = aU(o), n = i?.textPxLength || 0;
                    if (i && r) {
                        aW(this, "layOutTitle", {
                            alignTo: a,
                            key: t,
                        ...
                        let o = s.fontMetrics(i), h = o.b, l = o.h, d = r.verticalAlign || "top", c = "top" === d, p = c && r.minScale || 1, g = "title" === t ? c ? -3 : 0 : c ? e[0] + 2 : 0, u = Math.min(a.width / n, 1), f = Math.max(p, u), m = aU({
                            y: "bottom" === d ? h : g + h
                        }, {
                            align: "title" === t ? u < p ? "left" : "center" : this.title?.alignValue
                        }, r), x = (r.width || (u > p ? this.chartWidth : a.width) / f) + "px";
            ...
            temporaryDisplay(t) {
                ...
                if (t) for(; e?.style;)e.hcOrigStyle && (aO(e, e.hcOrigStyle), delete e.hcOrigStyle), e.hcOrigDetached && (aw.body.removeChild(e), e.hcOrigDetached = !1), e = e.parentNode;
                else for(; e?.style && (aw.body.contains(e) || e.parentNode || (e.hcOrigDetached = !0, aw.body.appendChild(e)), ("none" === aX(e, "display", !1) || e.hcOricDetached) && (e.hcOrigStyle = {
            ...
            getContainer() {
                ...
                if (this.renderer = new d(l, h, n, void 0, i.forExport, e.exporting?.allowHTML, this.styledMode), ax(void 0, this), this.setClassName(i.className), this.styledMode) for(let t in e.defs)this.renderer.definition(e.defs[t]);
            ...
            render() {
                ...
                for (let e of (this.setTitle(), aW(this, "beforeMargins"), this.getStacks?.(), this.getMargins(!0), this.setChartSize(), t)){
                    ...
                    if (this.hasCartesianSeries && e.horiz && e.visible && i.enabled && e.series.length && "colorAxis" !== e.coll && !this.polar) {
                        ...
                        let s = new sf(e, 0, "", !0), o = s.createLabel("x", i);
            ...
            addCredits(t) {
                let e = this, i = aU(!0, this.options.credits, t);
            ...
            update(t, e, i, s) {
                ...
                c && (aU(!0, n.options.chart, c), this.setZoomOptions(), "className" in c && n.setClassName(c.className), ("inverted" in c || "polar" in c || "type" in c) && (n.propFromSeries(), o = !0), "alignTicks" in c && (o = !0), "events" in c && av(this, c), a$(c, function(t, e) {
                    ...
                    t[e] && (aK(t[e]).forEach(function(t, s) {
                        let o, r = aE(t.id);
                        r && (o = n.get(t.id)), !o && n[e] && (o = n[e][aV(t.index, s)]) && (r && aE(o.options.id) || o.options.isInternal) && (o = void 0), o && o.coll === e && (o.update(t, !1), i && (o.touched = !0)), !o && i && n.collectionsWithInit[e] && (n.collectionsWithInit[e][0].apply(n, [
                            t
                ...
                let p = c?.width, g = c && (aY(c.height) ? a_(c.height, p || n.chartWidth) : c.height);
            ...
            showResetZoom() {
                let t = this, e = ay.lang, i = t.zooming.resetButton, s = i.theme, o = "chart" === i.relativeTo || "spacingBox" === i.relativeTo ? null : "plotBox";
                function r() {
                    t.zoomOut();
                }
            ...
            transform(t) {
                let { axes: e = this.axes, event: i, from: s = {}, reset: o, selection: r, to: a = {}, trigger: n } = t, { inverted: h, time: l } = this;
                this.hoverPoints?.forEach((t)=>t.setState()), aW(this, "transform", t);
                let d = t.hasZoomed || !1, c, p;
                for (let t of e){
                    let { horiz: e, len: g, minPointOffset: u = 0, options: f, reversed: m } = t, x = e ? "width" : "height", y = e ? "x" : "y", b = aV(a[x], t.len), v = aV(s[x], t.len), k = 10 > Math.abs(b) ? 1 : b / v, w = (s[y] || 0) + v / 2 - t.pos, M = w - ((a[y] ?? t.pos) + b / 2 - t.pos) / k, S = m && !h || !m && h ? -1 : 1;
                    if (!o && (w < 0 || w > t.len)) continue;
                    let T = t.chart.polar || t.isOrdinal ? 0 : u * S || 0, C = t.toValue(M, !0), A = t.toValue(M + g / k, !0), P = C + T, L = A - T, O = t.allExtremes;
                    if (r && r[t.coll].push({
                        axis: t,
                        min: Math.min(C, A),
                        max: Math.max(C, A)
                    ...
                    let { dataMin: E, dataMax: I, min: D, max: B } = az(t.getExtremes(), O || {}), N = l.parse(f.min), z = l.parse(f.max), R = E ?? N, W = I ?? z, H = L - P, X = t.categories ? 0 : Math.min(H, W - R), F = R - X * (aE(N) ? 0 : f.minPadding), G = W + X * (aE(z) ? 0 : f.maxPadding), j = t.allowZoomOutside || 1 === k || "zoom" !== n && k > 1, Y = Math.min(N ?? F, F, j ? D : F), U = Math.max(z ?? G, G, j ? B : G);
        ...
        class ni {
            ...
            constructor(t){
                ...
                let n = this.parentDiv = a5("div", {
                    ...
                    position: "relative"
                }, t.renderTo), h = this.scrollingContainer = a5("div", {
                    className: "highcharts-scrolling"
                }, a, n), l = this.innerContainer = a5("div", {
                    className: "highcharts-inner-container"
                }, void 0, h), d = this.fixedDiv = a5("div", {
        ...
        let { format: ns } = ep, { series: no } = rk, { destroyObjectProperties: nr, fireEvent: na, getAlignFactor: nn, isNumber: nh, pick: nl } = V, nd = class {
            ...
            render(t) {
                let e = this.axis.chart, i = this.options, s = i.format, o = s ? ns(s, this, e) : i.formatter.call(this);
            ...
            getStackBox(t) {
                let e = this.axis, i = e.chart, { boxTop: s, defaultX: o, xOffset: r, width: a, boxBottom: n } = t, h = e.stacking.usePercentage ? 100 : nl(s, this.total, 0), l = e.toPixels(h), d = t.xAxis || i.xAxis[0], c = nl(o, d.translate(this.x)) + r, p = Math.abs(l - e.toPixels(n || nh(e.min) && e.logarithmic && e.logarithmic.lin2log(e.min) || 0)), g = i.inverted, u = this.isNegative;
                return g ? {
        ...
        function nP(t, e) {
            ...
            for(k.stacksTouched += 1, h = 0; h < g; h++){
                let e = d[h] || 0, g = c[h], u = ny(g) && g || 0;
                n = (i = this.getStackIndicator(i, e, this.index)).key || "", w[a = (s = v && u < (m ? 0 : f)) ? b : y] || (w[a] = {}), w[a][e] || (M[a]?.[e] ? (w[a][e] = M[a][e], w[a][e].total = null) : w[a][e] = new nd(t, t.options.stackLabels, !!s, e, x)), o = w[a][e], null !== g ? (o.points[n] = o.points[this.index] = [
                    nv(o.cumulative, m)
                ], nf(o.cumulative) || (o.base = n), o.touched = k.stacksTouched, i.index > 0 && !1 === this.singleStacks && (o.points[n][0] = o.points[this.index + "," + e + ",0"][0])) : (delete o.points[n], delete o.points[this.index]);
                let S = o.total || 0;
        ...
        class nL {
            ...
            renderStackTotals() {
                let t = this.axis, e = t.chart, i = e.renderer, s = this.stacks, o = nc(e, t.options.stackLabels?.animation || !1), r = this.stackTotalGroup = this.stackTotalGroup || i.g("stack-labels").attr({
                    zIndex: 6,
                    opacity: 0
                }).add();
        ...
        class nB extends r1 {
            ...
            getGraphPath(t, e, i) {
                ...
                return l && t.reverse(), (h = ({
                    ...
                    (l.leftCliff || u?.rightCliff) && !i && (n = !0), f && !nE(e) && d > 0 ? n = !o.connectNulls : f && !e ? n = !0 : (0 === d || n ? c = [
                        [
                            "M",
                            l.plotX,
                            l.plotY
        ...
        class ht extends r1 {
            ...
            getColumnMetrics() {
                ...
                let l = Math.min(Math.abs(i.transA) * (!i.brokenAxis?.hasBreaks && i.ordinal?.slope || e.pointRange || i.closestPointRange || i.tickInterval || 1), i.len), d = l * e.groupPadding, c = (l - 2 * d) / (h || 1), p = Math.min(e.maxPointWidth || i.len, n8(e.pointWidth, c * (1 - 2 * e.pointPadding))), g = (t.columnIndex || 0) + +!!r;
            ...
            translate() {
                ...
                i.pointPadding && i.crisp && (f = Math.ceil(f)), r1.prototype.translate.apply(t), t.points.forEach(function(s) {
                    ...
                    h && Math.abs(k) < h && (k = h, b = !a.reversed && !s.negative || a.reversed && s.negative, n9(n) && n9(g) && s.y === n && g <= n && (a.min || 0) < n && (p !== g || (a.max || 0) <= n) && (b = !b, s.negative = !s.negative), v = Math.abs(v - u) > h ? o - h : u - (b ? h : 0)), n2(s.options.pointWidth) && (M -= Math.round(((w = S = Math.ceil(s.options.pointWidth)) - d) / 2)), i.centerInCategory && (M = t.adjustForMissingColumns(M, w, s, l)), s.barX = M, s.pointWidth = w, s.tooltipPos = e.inverted ? [
                        n0(a.len + a.pos - e.plotLeft - y, a.pos - e.plotLeft, a.len + a.pos - e.plotLeft),
                        ...
                        k
                    ], s.shapeType = t.pointClass.prototype.shapeType || "roundedRect", s.shapeArgs = t.crispCol(M, v, S, s.isNull ? 0 : k);
            ...
            drawTracker(t = this.points) {
                ...
                t.forEach(function(t) {
                    e = n6(t.dataLabels) ? t.dataLabels : t.dataLabel ? [
                        t.dataLabel
        ...
        !function(t) {
            ...
            function i(t, e, i, s, o) {
                let { chart: r, enabledDataSorting: a } = this, n = this.isCartesian && r.inverted, h = t.plotX, l = t.plotY, d = i.rotation || 0, c = ho(h) && ho(l) && r.isInsidePlot(h, Math.round(l), {
                    inverted: n,
                    paneCoordinates: !0,
                    series: this
                }), p = 0 === d && "justify" === hp(i.overflow, a ? "none" : "justify"), g = this.visible && !1 !== t.visible && ho(h) && (t.series.forceDL || a && !p || c || hp(i.inside, !!this.options.stacking) && s && r.isInsidePlot(h, n ? s.x + 1 : s.y + s.height - 1, {
                    inverted: n,
                    paneCoordinates: !0,
                    series: this
                })), u = t.pos();
            ...
            function r(t) {
                let e;
                t = t || this.points;
                let i = this, s = i.chart, o = i.options, r = s.renderer, { backgroundColor: a, plotBackgroundColor: l } = s.options.chart, d = r.getContrast(hl(l) && l || hl(a) && a || "#000000"), c = h(i), { animation: p, defer: g } = c[0], u = g ? hi(s, p, i) : {
                    defer: 0,
                    duration: 0
                };
        ...
        !function(t) {
            t.getCenter = function() {
                ...
                for(!e.angular || this instanceof r1 || (g[3] = 0), c = 0; c < 4; ++c)p = g[c], h = c < 2 || 2 === c && /%$/.test(p), g[c] = hB(p, [
                    s,
                    o,
                    a,
                    g[2]
                ...
                let i = hI(t) ? t : 0, s = hI(e) && e > i && e - i < 360 ? e : i + 360;
                return {
                    start: hO * (i + -90),
                    end: hO * (s + -90)
                };
        ...
        class hK extends r1 {
            ...
            getX(t, e, i, s) {
                let o = this.center, r = this.radii ? this.radii[i.index] || 0 : o[2] / 2, a = s.dataLabelPosition, n = a?.distance || 0, h = Math.asin(h$((t - o[1]) / (r + n), -1, 1));
            ...
            function s() {
                ...
                t.visible && t.hasDataLabels?.() && (e.forEach((t)=>{
                    ...
                    (t.dataLabels || []).forEach((e, i)=>{
                        let s = n[2] / 2, o = e.options, r = h8(o?.distance || 0, s);
                    ...
                    d && (t.sortByAngle(e, a - .5), m > 0 && (x = Math.max(0, l - h - m), y = Math.min(l + h + m, i.plotHeight), e.forEach((t)=>{
                        ...
                        (i.dataLabels || []).forEach((l)=>{
                            ...
                            if (x) {
                                if (g && h5(m) && x.distance > 0 && (void 0 === m.pos ? S = "hidden" : (f = m.size, M = p.radialDistributionY(i, l))), d.justify) w = p.justify(i, l, h, n);
            ...
            for(let i = 0; i < e; i++)(o = t[i]) && (o.oldOpacity = o.opacity, o.newOpacity = 1, o.absoluteBox = function(t) {
                if (t && (!t.alignAttr || t.placed)) {
                    let e = t.box ? 0 : t.padding || 0, i = t.alignAttr || {
                        x: t.attr("x"),
                        y: t.attr("y")
                    }, { height: s, polygon: o, width: r } = t.getBBox(), a = li(t.alignValue) * r;
        ...
        }, { defaultOptions: ld } = tv, { noop: lc } = w, { addEvent: lp, extend: lg, isObject: lu, merge: lf, relativeLength: lm } = V, lx = {
            radius: 0,
            scope: "stack",
            where: void 0
        }, ly = lc, lb = lc;
        function lv(t, e, i, s, o = {}) {
            let r = ly(t, e, i, s, o), { brStart: a = !0, brEnd: n = !0, innerR: h = 0, r: l = i, start: d = 0, end: c = 0 } = o;
            if (o.open || !o.borderRadius) return r;
            let p = c - d, g = Math.sin(p / 2), u = Math.max(Math.min(lm(o.borderRadius || 0, l - h), (l - h) / 2, l * g / (1 + g)), 0), f = Math.min(u, p / Math.PI * 2 * h), m = r.length - 1;
        ...
        function lk() {
            if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
                let { options: t, yAxis: e } = this, i = "percent" === t.stacking, s = ld.plotOptions?.[this.type]?.borderRadius, o = lw(t.borderRadius, lu(s) ? s : {}), r = e.options.reversed;
        ...
        function lS(t, e, i, s, o = {}) {
            let r = lb(t, e, i, s, o), { r: a = 0, brBoxHeight: n = s, brBoxY: h = e } = o, l = e - h, d = h + n - (e + s), c = l - a > -.1 ? 0 : a, p = d - a > -.1 ? 0 : a, g = Math.max(c && l, 0), u = Math.max(p && d, 0), f = [
                t + c,
                e
            ], m = [
                t + i - c,
...
//# sourceMappingURL=f51ce_highcharts_highcharts_b0ce8e0a.js.map