  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <main className="flex-1 overflow-auto">
        <div className="p-8">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Phân Tích Chuyến Đi</h1>
            <p className="text-gray-600">Xem chi tiết thống kê và phân tích về chuyến đi của bạn</p>
          </div>
