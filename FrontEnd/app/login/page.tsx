        ...
        <div className="fixed inset-0 z-50 overflow-hidden">
            ...
            <div className="relative z-10 flex items-center justify-center min-h-screen p-4 sm:p-6 lg:p-8">
                ...
                >
                    ...
                    >
                        {/* Glass card */}
                        <div className="relative rounded-2xl lg:rounded-3xl bg-white/5 backdrop-blur-2xl border border-white/10 p-6 sm:p-8 lg:p-12 shadow-2xl">
                            {/* Close button */}
                            <Link
                                href="/overview"
                                className="absolute top-4 right-4 sm:top-6 sm:right-6 w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-white/5 backdrop-blur-sm border border-white/10 flex items-center justify-center hover:bg-white/10 transition-all duration-300 group"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white/60 group-hover:text-white transition-colors sm:w-5 sm:h-5">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
                                ...
                                >
                                    <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-3 sm:mb-4">
                                        <Sparkles className="w-3 h-3 sm:w-4 sm:h-4 text-cyan-400" />
                                        <span className="text-xs sm:text-sm text-cyan-400 font-medium">ADAS Platform</span>
                                    </div>
                                    <h1 className="text-3xl sm:text-4xl lg:text-4xl font-bold bg-gradient-to-r from-white via-cyan-200 to-blue-200 bg-clip-text text-transparent">
                                        Đăng Nhập
                                    </h1>
                                    <p className="text-sm sm:text-base text-white/50">Chào mừng trở lại!</p>
                                </motion.div>
                                ...
                                <motion.button
                                    ...
                                    type="submit"
                                    disabled={loading}
                                    className="w-full h-14 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-400 text-white font-semibold shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40 transition-all duration-300 flex items-center justify-center gap-2 group disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {loading ? (
