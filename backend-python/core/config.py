...
class Settings(BaseSettings):
    ...
    def DATABASE_URL(self) -> str:
        ...
        if self.SQL_SERVER and self.SQL_USERNAME and self.SQL_PASSWORD:
    ...
    AUTO_LEARNING_THRESHOLD: int = 100  # Min samples to trigger auto training
...
def print_startup_info():
    ...
    print(f"Auto Learning: {'Enabled' if settings.ENABLE_AUTO_LEARNING else 'Disabled'}")
