...
""")
            ...
            # Train YOLOv8n
            self.training_status["message"] = "Training YOLOv8n..."
            ...
            # Save trained model
            trained_model_path = Config.MODELS_DIR / "yolov8n_trained" / "weights" / "best.pt"
            if trained_model_path.exists():
                shutil.copy(trained_model_path, Config.MODELS_DIR / "yolov8n.pt")
                logger.info("✓ YOLOv8n training completed")
...
async def get_status():
    ...
    return ModelStatus(
        yolov8n_loaded=model_manager.models.get("yolov8n") is not None,
        yolov8m_loaded=model_manager.models.get("yolov8m") is not None,
