...
# CORS Configuration - Allow ALL origins for Cloudflare Tunnel access
app.add_middleware(
    CORSMiddleware,
...
async def api_status(db: Session = Depends(get_db)):
    """Complete API status with database check"""
    try:
    ...
    return {
        ...
        "endpoints": {
            ...
            "alerts": "/api/alerts/latest",
            "dataset": "/api/dataset/stats",
            "training": "/api/training/list",
            "inference": "/api/inference/image",
            "websocket": "/ws/infer"
        }
    }
...
async def root():
    ...
    return {
        "message": "ADAS Backend API - Advanced Driver Assistance System",
        "version": "3.0.0",
        "description": "AI-powered ADAS with real-time detection, training, and auto-learning",
        "docs": "/docs",
        "health": "/health",
        "status": "/api/status",
        "features": [
            "Real-time Object Detection (YOLOv11)",
            "Auto Data Collection & Labeling",
        ...
        "endpoints": {
            ...
            "detections": "/api/detections/recent",
            "alerts": "/api/alerts/latest",
            "dataset": "/api/dataset/videos",
            "training": "/api/training/list",
            "auto_learning": "/api/auto-learning/stats",
            "inference": "/api/inference/image",
            "websocket": "/ws/infer"
        },
...
if __name__ == "__main__":
    ...
    uvicorn.run(
        "main:app",
        host="0.0.0.0",
        port=8080,  # Changed from 8000 to 8080 for Cloudflare Tunnel compatibility
        reload=True,
        log_level="info"
    )
